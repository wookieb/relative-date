...
class MonthsAgoRuleTest extends AbstractRuleTest
{
    ...
    public function cases()
    {
        return [
            ...
            $this->createCase($this->createRequest('2015-01-01 00:00:00', '2015-04-05 00:00:00'), Results::MONTHS_AGO, 3),
            $this->createCase($this->createRequest('2015-01-01 00:00:00', '2015-12-31 23:59:59'), Results::MONTHS_AGO, 11),
            $this->createCase($this->createRequest('2015-01-01 00:00:00', '2016-01-01 00:00:00'), null),
